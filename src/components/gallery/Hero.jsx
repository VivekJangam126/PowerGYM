function Hero() {
    ...
    return (
        <div className="relative w-screen h-screen overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 h-110 transform -translate-x-1/2 -translate-y-1/2 text-center z-20">
            ...
            <div className="absolute inset-0 bg-black/40 z-10 h-162" />
        </div>
    );
}
export default Hero;
